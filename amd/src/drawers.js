 ...
 *
 * @module     theme_boost_preview/drawers
...
// The jQuery module is only used for interacting with boost_previewrap 4. It can we removed when MDL-71979 is integrated.
...
const disableButtonTooltip = (button, enableOnBlur) => {
    if (button.hasAttribute('data-original-title')) {
        // The jQuery is still used in boost_previewrap 4. It can we removed when MDL-71979 is integrated.
...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_boost_preview/drawers:show}
     * @property {String} drawerShown See {@link event:theme_boost_preview/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_boost_preview/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_boost_preview/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_boost_preview/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_boost_preview/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_boost_preview/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_boost_preview/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_boost_preview/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_boost_preview/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_boost_preview/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_boost_preview/drawers:hidden',
    };
     ...
     * @returns {module:theme_boost_preview/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_boost_preview/drawers:open');
    ...
    closeDrawer({focusOnOpenButton = true, updatePreferences = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_boost_preview/drawers:close');
     ...
     *
     * @param {module:theme_boost_preview/drawers} comparisonInstance
     */

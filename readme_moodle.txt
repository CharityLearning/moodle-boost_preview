...
* remove folder theme/boost_preview/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/boost_preview/scss/bootstrap
...
* comment out this line in theme/boost_preview/scss/_print.scss
    @page {
...
* remove folder theme/boost_preview/amd/src/bootstrap
* copy the js files from ~/bootstrap/js/src to theme/boost_preview/amd/src/bootstrap (including the subfolder)
* copy index.js from ~/bootstrap/js to theme/boost_preview/amd/src
* edit theme/boost_preview/amd/src/index.js and update import path (src -> bootstrap)
